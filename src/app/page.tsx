        ...
        <section className="pt-20 pb-12 md:pt-28 md:pb-16">
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-white/62 sm:text-lg">
              Vestaryn combines conversational reasoning, deterministic tool
              execution, staged file proposals, and verification before apply.
            </p>
...
>
  ...
  Enter the Chamber
                ...
                <Link
                  href="/login"
                  className="rounded-2xl border border-white/10 bg-white px-5 py-3 text-sm font-medium text-black hover:bg-white/90"
                >
                  Enter with Early Access
                </Link>
              )}
            ...
            {user?.email ? (
              ...
              <div className="mt-4 text-xs text-white/35">
                Invitation-only while the chamber is being refined for broader
                release.
              </div>
            )}
          </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-md">
              ...
              <form action="/api/repos" method="post" className="mt-4 flex gap-2">
                <input
                  ...
                  className="flex-1 min-w-0 rounded-xl border border-white/10 bg-black/30 px-3 py-2.5 text-sm text-white/85 placeholder:text-white/35 outline-none focus:ring-1 focus:ring-blue-400/40"
                />
        ...
        >
          ...
          <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-5">
            {["Ask", "Propose", "Verify", "Approve", "Apply"].map((step) => (
              <div
                key={step}
className="relative rounded-2xl border border-white/10 bg-black/30 px-4 py-4 text-sm text-white/85
shadow-[inset_0_0_12px_rgba(59,130,246,0.08)]
hover:border-blue-400/20
hover:shadow-[inset_0_0_18px_rgba(59,130,246,0.18)]
after:absolute after:left-3 after:right-3 after:top-0 after:h-px after:bg-blue-400/20 after:opacity-40
        ...
        <section className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-[1.25fr_0.75fr]">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 backdrop-blur-md">
            ...
            <h3 className="mt-3 text-xl font-semibold text-white/92">
              Invitation-only while the chamber is being refined.
            </h3>

            <p className="mt-4 text-sm leading-6 text-white/55">
              Early access is focused on developers, learners, and small teams
              exploring controlled AI-assisted repository change.
            </p>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white/50">
                No public signup yet. Broader access comes later.
              </div>
            </div>
          </div>
        </section>
